...
interface EditSchoolStaffPageProps {
  params: Promise<{ subAppKey: string; id: string }>
}

export async function generateMetadata({ params }: EditSchoolStaffPageProps) {
...
export default async function EditSchoolStaffPage({ params }: EditSchoolStaffPageProps) {
