...
interface NewFoundationStaffPageProps {
  params: Promise<{ subAppKey: string }>
}

export async function generateMetadata({ params }: NewFoundationStaffPageProps) {
...
export default async function NewFoundationStaffPage({ params }: NewFoundationStaffPageProps) {
  const { subAppKey } = await params
